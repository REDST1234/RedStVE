...
import CategoryKnowledgeGraph from './pages/deconstruct/CategoryKnowledgeGraph';
...
import ProjectRecommendation from './pages/create/ProjectRecommendation';
      ...
      <ToastProvider>
        <Routes>
          ...
          <Route element={<MainLayout />}>
            ...
            <Route path="deconstruct/categories" element={<CategoryKnowledgeGraph />} />
            ...
            <Route path="create/detail/:id/recommendation" element={<ProjectRecommendation />} />
